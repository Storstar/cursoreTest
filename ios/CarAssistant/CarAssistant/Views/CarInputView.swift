        ...
        if brandError == nil && modelError == nil && yearError == nil && engineError == nil {
            if let user = authViewModel.currentUser {
                ...
                carViewModel.saveCar(
                    ...
                    fuelType: selectedFuelType.isEmpty ? nil : (Localization.FuelType.key(for: selectedFuelType) ?? selectedFuelType),
                    driveType: selectedDriveType.isEmpty ? nil : (Localization.DriveType.key(for: selectedDriveType) ?? selectedDriveType),
                    transmission: selectedTransmission.isEmpty ? nil : (Localization.Transmission.key(for: selectedTransmission) ?? selectedTransmission),
