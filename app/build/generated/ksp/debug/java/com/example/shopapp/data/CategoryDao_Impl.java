  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`description`,`imageUrl`) VALUES (?,?,?,?)";
      }
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Category(_tmpId,_tmpName,_tmpDescription,_tmpImageUrl);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpImageUrl;
            _tmpImageUrl = _cursor.getString(_cursorIndexOfImageUrl);
            _result = new Category(_tmpId,_tmpName,_tmpDescription,_tmpImageUrl);
          } else {
            _result = null;
          }
          return _result;
